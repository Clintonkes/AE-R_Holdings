...
export function ContactCTA() {
  return (
    <section className="bg-[#0F172A] py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#2DD4BF]/5 rounded-full translate-y-1/2 -translate-x-1/2" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          {/* Icon */}
          <div className="inline-flex w-16 h-16 bg-[#2DD4BF]/10 rounded-2xl items-center justify-center mb-6">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-6">
            Ready for a{' '}
            <span className="text-[#2DD4BF]">Spotless Home?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            ...
            >
              <div className="w-10 h-10 bg-[#2DD4BF] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/booking"
              className="inline-flex items-center gap-2 bg-[#2DD4BF] text-[#0F172A] font-bold px-8 py-4 rounded-full text-base hover:bg-[#14B8A6] hover:scale-105 transition-all duration-300 shadow-lg shadow-[#2DD4BF]/20"
            >
              Book Now
